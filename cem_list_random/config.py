...
class Constants(BaseConstants):
    ...
    # ---------------------------------------------------------------------------------------------------------------- #
    # --- set decision weight of each group member ------------------------------------------------------------------- #
    # --- weights_cum is the cumulative version of weights ----------------------------------------------------------- #
    # --- both need to be correctly specified ------------------------------------------------------------------------ #
    # ---------------------------------------------------------------------------------------------------------------- #
    weights = (1/3, 1/3, 1/3)
    weights_cum = (0, 1/3, 2/3, 1)
    ...
    lottery_hi = (10.00, 10.00, 10.00, -10.00, -10.00, -10.00)
    ...
    sure_payoff = (0, 2.50, 5.00, -2.00, -5.00, -5.00)
    ...
    step_size = (0.2, 0.5, 0.5, 0.2, 0.5, 0.5)
