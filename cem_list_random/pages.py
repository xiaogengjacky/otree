...
class Pausepage(Page):
    ...
    def vars_for_template(self):
        ...
        option_to_pay_p1 = \
        self.player.get_others_in_group()[0].participant.vars['cem_choices_made'][rand_num - 1][
            row_to_pay - 1]
        option_to_pay_p2 = \
        self.player.get_others_in_group()[1].participant.vars['cem_choices_made'][rand_num - 1][
            row_to_pay - 1]
