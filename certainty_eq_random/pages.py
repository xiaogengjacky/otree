...
def vars_for_all_templates(self):
    ...
    return{
        ...
        'id_self': id_self,
        'weight_self': format(Constants.weight[id_self - 1], ",.2%"),
        'id_other1': id_other1,
        'weight_other1': format(Constants.weight[id_other1 - 1], ",.2%"),
        'id_other2': id_other2,
        'weight_other2': format(Constants.weight[id_other2 - 1], ",.2%")
...
class Pausepage(Page):
    ...
    def is_displayed(self):
        ...
        selection = self.player.group.in_round(rand_round).selection
        ...
        self.participant.vars['result_info'] = [id_self, id_other1, id_other2, ce_p, ce_p1, ce_p2,
                                                self.group.in_round(rand_round).payoff, selection]
