...
SECRET_KEY = '3+)q_)z$l64f4z_pv5)!rnl=-ctw5k)bu3kiwm)_g=%)4jx&^^'
...
#     },
    ...
    },
    {
        ...
        'num_demo_participants': 3,
        'real_world_currency_per_point': 0.05,
        'app_sequence': ['certainty_eq', 'gneezy_potters', 'survey', 'payment_info'],
    },
    {
        'name': 'CE_GP_group',
        'display_name': "CE+GP (Group Voting)",
        'num_demo_participants': 3,
        'real_world_currency_per_point': 0.05,
        'app_sequence': ['certainty_eq_group', 'gneezy_potters_group', 'survey', 'payment_info'],
    },
    {
        'name': 'CE_GP_random',
        'display_name': "CE+GP (Random Selection)",
        'num_demo_participants': 3,
        'real_world_currency_per_point': 0.05,
        'app_sequence': ['certainty_eq_random', 'gneezy_potters_random', 'survey', 'payment_info'],
    }

]

SENTRY_DSN = 'http://effa011612924da9a31880f18e1460c8:f637595de9794b54a2ff3fc367130605@sentry.otree.org/296'
