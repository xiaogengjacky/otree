...
from certainty_eq_group.config import *
...
doc = """
Certainty equivalent with specified values. Group voting rule.
"""
...
class Group(BaseGroup):
    ...
    def set_group_payoffs(self, round_num):
        ...
        self.ce = median([p.participant.vars['ce'][round_num - 1] for p in self.get_players()])
